...
#	@ author	: carroll
#	@ purpose	: this file generates breadcrumbs from path information. 
# 	@ created	: 2011-12-20 1009
# 	@ modified	: 2012-02-21 1625 carroll
#	@ previous	: 2012-01-02 0252 carroll
#	+ 
#	+ 
***/
...
class breadcrumbs {
	...
	private function fixNames($string) {
		...
		/*
			swap values for uri strings
			- used mostly, to capitalize abbreviations from the URI instead of title casing them
		*/
		$case_swap = array(
			'cta'		=> 'CTA',
			'rss'		=> 'RSS'
		);
		$string = str_ireplace(array_keys($case_swap), array_values($case_swap), $string);
