            ...
            <li class="nav-item">
                ...
                <div class="sub-nav">
                    <ul class="sub-nav-group">
                        ...
                        <li><a href="/departments/instructional-support-student-activities/athletics">Secondary Student Athletics and Activities</a></li>
                    ...
                    <ul class="sub-nav-group">
                        ...
                        <li class="extra-space"><a href="/students/resources/pdf/BellSchedule-2022-2023-external.pdf" class="long-link">School Bell Schedule (PDF)</a></li>
...
-->
					<div style="padding-left: 450px;margin-top:20px">
                     <ul class="sub-nav-group" style="width: 40%; padding-bottom: 35px;margin-top:-30px;">
                       ...
                       <li><a href="/parents/">Assembly Bill 195 - English Language Learner Division</a></li>
...
<!--                         <li class="extra-space"><a href="/departments/cpd/" class="long-link">Curriculum and Professional Development Division</a></li> -->
                        ...
                        <li class="extra-space"><a href="https://sites.google.com/nv.ccsd.net/2021-2022reopening" class="long-link" target="_blank">Back to School Implementation Guide</a></li>
                        <li><a href="/employees/canvas/">Canvas LMS</a></li>
                    ...
                    <ul class="sub-nav-group" style="width: 45%;margin-top:-30px;">
                        <li class="section-headline">Additional Information</li>
            ...
            <li class="nav-item">
                ...
                <div class="sub-nav">
                    <ul class="sub-nav-group">
                        ...
                        <li><a href="http://teachvegas.ccsd.net/">Job Application Process</a></li>
					...
					<!-- DISTRICT D -->
                        ...
                        <li>
                            <a href="/trustees/details/D" class="long-link">
                                <span class="trustee-img"><img src="/trustees/includes/images/district-d-19.jpg" alt="Trustee-District D"></span>
                    ...
                    <ul class="sub-nav-group trustees">
                        ...
                        <li>
                            <a href="/trustees/details/F" class="long-link">
                                <span class="trustee-img"><img src="/trustees/includes/images/district-f-19.jpg" alt="Trustee-District F"></span>
                                <span class="trustee-title">Member</span><br>
            ...
            <li class="nav-item">
                ...
                <div class="sub-nav">
                    <ul class="sub-nav-group trustee">
                        ...
                        <li><a href="https://engage.ccsd.net/">Community Relations</a></li>
