...
<div id="header_alert">
    <div id="alert_inner">
        ...
        <div id="clear"></div>
        <p><a id="alert-banner" href="/district/resources/pdf/CCSD-coronavirus-message-3-5-20.pdf">View the latest update from CCSD regarding coronavirus (PDF)</a></p>
    </div>
</div>
            ...
            <li class="nav-item">
                ...
                <div class="sub-nav">
                    ...
                    <ul class="sub-nav-group">
                        ...
                        <li><a href="/employees/current/resources/#support">Support Staff</a></li>
            ...
            <li class="nav-item">
                ...
                <div class="sub-nav">
                	<ul class="sub-nav-group trustees-general">
                  		...
                  		<li class="extra-space"><a href="/trustees/meeting-agendas/2020" class="long-link">2020 Board Meeting Agendas</a></li>
                    ...
                    <ul class="sub-nav-group trustees">
                        ...
                        <li>
                            <a href="/trustees/details/B" class="long-link">
                                ...
                                <span class="trustee-title">Member</span><br>
                                <span class="trustee-name">Chris Garvey</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="sub-nav-group trustees">
                        ...
                        <li>
                            <a href="/trustees/details/A" class="long-link">
                                ...
                                <span class="trustee-title">Member</span><br>
                                <span class="trustee-name">Deanna L. Wright</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="sub-nav-group trustees">
                        ...
                        <li>
                            <a href="/trustees/details/C" class="long-link">
                                ...
                                <span class="trustee-title">Member</span><br>
                                <span class="trustee-name">Dr. Linda E. Young</span>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="sub-nav">
                    ...
                    <ul class="sub-nav-group">
                       ...
                       <ul class="sub-nav-group">
                        ...
                        <li><a href="http://my.ccsd.net/" target="_blank">my.ccsd.net</a></li>
                        <li class="extra-space"><a href="/district/info/non-discrimination/" class="long-link">Notice of Nondiscrimination</a></li>
