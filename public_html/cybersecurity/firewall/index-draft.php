...
<!--        header-->
        <section class="content-holder">
            <div style="display: flex; align-items: center; gap: 20px;">
                <img src="https://ccsd.net/cybersecurity/images/FirewallFinalApproved.png" alt="Firewall Dragon"
                     style="max-width: 20%; height: auto;">
                <div>
                    <h1>Firewall the Dragon</h1>
                    <h2 style="text-align:left !important;font-size:24px !important;">Safe, Smart, and Secure—With
                        Firewall by Your Side</h2>
                </div>
            </div>
            <h3>Firewall's Origin</h3>
            <p>Firewall was not always the friendly face of cybersecurity. He started out as a forgotten line of code tucked inside a dusty old school laptop. But after watching too many students click suspicious links and fall for tricky scams, he knew he had to do something.</p>
            <p>One reboot later, he came to life—part firewall, part dragon, all heart.</p>
            <p>
Now, Firewall spends his days flying through CCSD’s digital skies, helping students make smart choices online. He is playful, a little nerdy, and fiercely protective of every student’s digital safety. If it is sketchy, spammy, or shady, Firewall is already on it.
            </p>
            
             <h3>Firewall’s Role</h3>
...
<!--
            ...
            <div class="container-jobs">
                <div class="card">
                    <img src="https://ccsd.net/cybersecurity/images/malwarebytes.png" alt="Malwarebytes">
                ...
                <div class="card">
                    <img src="https://ccsd.net/cybersecurity/images/womn.png" alt="Who’s on My WiFi – Network monitoring">
                ...
                <div class="card">
                    <img src="https://ccsd.net/cybersecurity/images/gfl.png" alt="Google Family Link – Track activity">
